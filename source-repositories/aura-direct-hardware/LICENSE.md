...
This is a plain-language licence for Aura Direct Hardware.
...
Schools, universities, co-operatives, charities, community bodies and government programmes remain inside this section when their use is genuinely non-commercial educational, research or community work, keeps clear attribution, and does not become procurement, paid service delivery or closed institutional deployment.

If you use or adapt the work, give clear credit:

Based on Aura Direct Hardware by Luke Nathan Hayes / Strange But True / Aura of Intelligence.
Original project: https://github.com/auraofintelligence/aura-direct-hardware
Used under the Strange But True Public Source Licence.

## 2. What You Cannot Do Without Permission

You may not use this repo's copyrighted expression and original material, such as its code, text, designs, workflows, assets, names or close derivatives, for commercial, corporate, startup, agency, client, employer or paid service purposes without written permission from Luke Nathan Hayes.

That means you may not:

- sell, monetise, repackage, licence, sponsor, advertise with or commercially distribute the work;
- use it in paid products, SaaS tools, client work, consulting, commercial courses or workshops, dashboards, templates or commercial infrastructure;
- use it inside a company or startup, or in institutional or government procurement, paid service delivery or closed internal deployment outside the non-commercial uses in section 1;
...
Public prototypes remain experiments. They carry no claim of legal, medical, financial, privacy, security, public-safety, governance, crypto, AI-governance or production fitness. A statement from Luke does not replace independent evidence, professional judgement, certification, regulation or the duties of the people who deploy the work.
