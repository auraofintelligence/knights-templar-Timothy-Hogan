...
export const pages=[
 ...
 page('network','The network I want to build','Founder opportunities, sovereign computing and different forms of value.','network',[
  ...
  section('compute','Sovereign computing',[
   ...
   "My submission to the Independent AUKUS Public Inquiry's Brisbane public hearing, dated 24 August 2026, asks what positive-sum security options were considered alongside the submarine program. It does not pretend submarines and civic AI infrastructure perform the same task. It argues that Australian security also includes sovereign compute, education, disaster resilience, scientific capability and peaceful regional cooperation, and asks why the nation should place its future in one program, alliance, vendor ecosystem or definition of security."
