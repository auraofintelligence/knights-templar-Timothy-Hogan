...
export const pages=[
 ...
 page('network','The network I want to build','Founder opportunities, sovereign computing and different forms of value.','network',[
  ...
  section('compute','Sovereign computing',[
   "My August 2026 AI papers address the Australian Parliament's Senate Environment and Communications References Committee and its inquiry into Artificial intelligence and data centres. This is a federal inquiry into regulation, government dealings with global AI companies, and impacts on communities, industry, energy, water and the environment. A Fair Go for the AI Age develops the community-compute case; Do Not Put All Our Eggs in One Basket sets out the wider architecture and rollout.",
   "I propose filling the gap between personal devices and hyperscale data centres with locally useful computing infrastructure. The first national cohort would have 32 deliberately different sites, at least four in every state and territory. My A$6 million planning allowance per frontier node includes the installation, power, cooling, security, community laboratory, XR training and initial support. Each host would learn, document its experience and teach the next cohort, with older equipment moving into places where it remains useful.",
   "I ask the Commonwealth to support the national backbone, open models, shared standards and funding. I propose that states and territories connect this with energy, planning, education and emergency management, while councils and community institutions host place-based capacity. Personal information stays under personal control. First Nations governance runs across the architecture wherever Country, cultural knowledge and collective data are involved; it is not another tier beneath government.",
   "In Queensland, I envisage a learning network connecting Pullenvale, Moreton Bay, Brisbane, Redlands and Minjerribah. My Brisbane 2032 proposal is to train a permanent Civic Reserve through the Olympic and Paralympic volunteer effort, retaining those skills afterwards for community work, disaster response, science and future space stewardship. Aura Direct Hardware explores the underlying machines and the freedom to understand, repair and change the tools."
  ],[{label:'Senate inquiry: Artificial intelligence and data centres',href:'https://www.aph.gov.au/Parliamentary_Business/Committees/Senate/Environment_and_Communications/AIdatacentres48P'},link('Fair Go research brief','library/source-37/'),link('Postcode-level submission draft','library/source-38/'),link('Do Not Put All Our Eggs in One Basket','library/source-39/'),repo('Aura Direct Hardware','aura-direct-hardware')]),
  ...
  section('cooperation','Family without assimilation',[
   ...
   "These treaty submissions extend the local-government and AI infrastructure work into an international setting. The Native Nations and Oceania cinema projects explore those relationships through imagined futures; the multi-site Minjerribah network returns to the places and infrastructure around my own home."
  ],[{label:'JSCOT inquiry: Fiji-Australia Vuvale Union',href:'https://www.aph.gov.au/Parliamentary_Business/Committees/Joint/Treaties/FijiAUVuvale'},link('My Vuvale submission','library/source-41/'),{label:'JSCOT inquiry: Ocean of Peace Alliance',href:'https://www.aph.gov.au/Parliamentary_Business/Committees/Joint/Treaties/OceanofPeaceAlliance'},link('My Ocean of Peace submission','library/source-42/'),repo('Minjerribah network','multi-site-Minjerribah-network'),repo('Native Nations cinema','p4a-native-nations-cinema'),repo('Oceania cinema','p4a-oceania-cinema')])
 ]),
