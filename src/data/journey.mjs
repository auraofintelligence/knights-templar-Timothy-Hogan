...
export const pages=[
 ...
 page('network','The network I want to build','Founder opportunities, sovereign computing and different forms of value.','network',[
  ...
  section('compute','Sovereign computing',[
   ...
   "Queensland could test the complete stack: CSIRO Vetra at Pullenvale, universities and health networks, the proposed PsiQuantum facility at Moreton Bay, Brisbane 2032, Redlands and Minjerribah, the Gold Coast and wider national and international networks. I live on Minjerribah, and I have nominated 9 Ballow Road in Dunwich as one possible locally grounded community-compute, learning and disaster-resilience pilot. An island testbed could examine offline operation, backup communications, local energy, environmental modelling, public access and respectful First Nations data-governance pathways.",
  ...
  ],[{label:'Senate inquiry: Artificial intelligence and data centres',href:'https://www.aph.gov.au/Parliamentary_Business/Committees/Senate/Environment_and_Communications/AIdatacentres48P'},link('Fair Go research brief','library/source-37/'),link('Postcode-level submission draft','library/source-38/'),link('Do Not Put All Our Eggs in One Basket','library/source-39/'),{label:'Read my AUKUS Public Inquiry submission',href:'https://auraofintelligence.github.io/multi-site-Minjerribah-network/source-documents/aukus-public-inquiry-submission.pdf'},{label:'9 Ballow Road pilot concept',href:'https://auraofintelligence.github.io/ready-set-co-op-trust-hub/ballow-road.html'},repo('Aura Direct Hardware','aura-direct-hardware')]),
 ...
 page('about','Luke Nathan Hayes','The life, philosophy and creative work behind the projects.','culture',[
  section('background','From the human question to the code',[
   ...
   "My current sole-trader small business is Strange but True: Tech, art and ideas that'll help. It is the practical public doorway for the technology support, creative work and useful ideas I can offer now, while the larger ecosystem continues to grow. LukeCatalyst.com is my earlier portfolio and preserves another stage of that journey."
  ],[{label:"Strange but True: Tech, art and ideas that'll help",href:'https://auraofintelligence.github.io/strange-but-true/index.html'},{label:'Earlier portfolio: LukeCatalyst.com',href:'https://lukecatalyst.com/'},link('Most recent CV','library/source-63/'),link('Work and education timeline','library/source-35/'),repo('The man and mind project','luke-nathan-hayes-man-and-mind')]),
  section('aura-intelligence','Aura of Intelligence',[
   "Aura of Intelligence is the operating system I have been building to turn artificial intelligence into a personal higher mind of one's infinite selves to wear as an Aura. It is not merely another app or chatbot. I imagine it as a self-sovereign and evolving interface for memory, values, identity, learning, relationships, creativity and action: clothing rather than skin, shaped by the person it serves and removable without surrendering the self.",
   "The July 2023 Version 7 presentation sets out Aura as a personal AI, life simulator and social web, backward-compatible with mobile devices and ready for wearables and mixed reality. Its interior view is private and its exterior view can be public. Blend Aura to Unity carries that architecture into an interactive seven-layered horn-torus data space where memories, narratives and machine-learning vectors have addresses, and where new connections can leave trace records through voice, movement and immersive tools.",
   "GAJRA Earth is the planetary horizon around Aura: a Global Association for Joyful Responsible Abundance expressed through interconnected Auras, mixed-reality experiences, art, music, games, cities and civic participation. GAJRA Earth Infinity and the separate Claude build are two public explorations of that larger vision."
  ],[{label:'Aura of Intelligence',href:'https://auraofintelligence.github.io/'},link('Version 7 Aura of Intelligence','library/source-33/'),link('Blend Aura to Unity','library/source-62/'),{label:'GAJRA Earth Infinity',href:'https://auraofintelligence.github.io/GAJRA-earth-infinity/'},{label:'GAJRA Earth Claude Build',href:'https://auraofintelligence.github.io/gajra-earth-claude-build/'}]),
