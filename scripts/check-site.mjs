...
assert.ok(projectsHTML.indexOf('id="auraofintelligence.github.io"')>projectsHTML.indexOf('id="strange-but-true-cosmic-nexus"')&&projectsHTML.indexOf('id="auraofintelligence.github.io"')<projectsHTML.indexOf('id="micronova-and-excursions"'),'The main Aura operating system must be the second featured project');
assert.ok(projectsHTML.includes("personal higher mind of one&#39;s infinite selves")&&projectsHTML.includes('href="https://auraofintelligence.github.io/"'),'The Aura project card must explain the operating system and link its public home');
